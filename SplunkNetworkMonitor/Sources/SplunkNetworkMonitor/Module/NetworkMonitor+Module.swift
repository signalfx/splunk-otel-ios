...
extension NetworkMonitor: Module {
    ...
    /// The type used for local configuration of the Network Monitor module.
    public typealias Configuration = NetworkMonitorConfiguration
    /// The type used for remote configuration of the Network Monitor module.
    public typealias RemoteConfiguration = NetworkMonitorRemoteConfiguration

    /// The metadata type for events generated by the Network Monitor module.
    public typealias EventMetadata = NetworkMonitorMetadata
    /// The data payload type for events generated by the Network Monitor module.
