...
// MARK: - TrackedData Protocol

public protocol TrackedData: SplunkTrackable {
    ...
    var context: [String: EventAttributeValue]? { get }
...
public extension TrackedData {
    var context: [String: EventAttributeValue]? { nil }
