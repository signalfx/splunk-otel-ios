...
xcodebuild -workspace SplunkRumWorkspace/SplunkRumWorkspace.xcworkspace \-scheme SmokeTest clean archive -configuration release \-sdk iphoneos -archivePath SplunkRumWorkspace.xcarchive
