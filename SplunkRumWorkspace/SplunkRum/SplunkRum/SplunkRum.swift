...
@objc public class SplunkRumOptions: NSObject {
     ...
     */
    @objc public var beaconUrl: String!

    /**
        The configured RUM access token for the library.
     */
    @objc public var rumToken: String!
...
@objc public class SplunkRum: NSObject {
    ...
    @objc public class func initialize(beaconUrl: String, rumAuth: String, options: SplunkRumOptions? = nil) -> Bool {
        ...
        if beaconUrl.isEmpty || rumAuth.isEmpty {
            print("SplunkRum: It is mandatory to provide a rumAccessToken, a beaconUrl (or a full beaconEndpoint) when creating a Config instance.")
            return false
        }
