...
public extension InternalLoggerConfiguration {
    ...
    /// "CiscoRUM Crash Reporter" and a variable category.
    ///
    /// - Parameters:
    ///  - category: More finely-grained category of the logged subsystem.
    static func crashReporter(subsystem: String = "CiscoRUM Crash Reporter", category: String) -> InternalLoggerConfiguration {
