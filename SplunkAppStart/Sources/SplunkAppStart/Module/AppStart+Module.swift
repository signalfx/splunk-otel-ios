...
extension AppStart: Module {
    ...
    /// The type used for local configuration of the AppStart module.
    public typealias Configuration = AppStartConfiguration
    /// The type used for remote configuration of the AppStart module.
    public typealias RemoteConfiguration = AppStartRemoteConfiguration

    /// The metadata type for events generated by the AppStart module.
    public typealias EventMetadata = AppStartMetadata
    /// The data payload type for events generated by the AppStart module.
