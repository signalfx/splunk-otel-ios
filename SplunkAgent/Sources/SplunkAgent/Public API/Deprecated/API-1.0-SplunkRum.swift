...
extension SplunkRum {
    ...
    public static func isInitialized() -> Bool {
        Self.shared.state.status == .running
    }
    ...
    public static func setGlobalAttributes(_ attributes: [String: Any]) {
        ...
        Self.shared.globalAttributes.addDictionary(globalAttributes.getAll())
    }
    ...
    public static func removeGlobalAttribute(_ key: String) {
        Self.shared.globalAttributes[key] = nil
    }
