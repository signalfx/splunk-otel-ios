...
public class SplunkRumBuilder {
    ...
    @discardableResult
    public func enableDiskCache(enabled _: Bool) -> SplunkRumBuilder {
        self
    }
    ...
    /// Specifies whether the SlowFrameDetection should be activated and generate slow and frozen frame detection spans.
    ///
    /// - Parameter isEnabled: If `true`, the SlowFrameDetection module generates slow and frozen frame detection spans.
    ///
    /// - Returns: The updated builder instance.
    ...
    /// Network Instrumentation can ignore URLs as appropriate.
    ///
    ...
    public func build() -> Bool {
        ...
        let attributes = buildAttributes(from: globalAttributes)
    ...
    private func buildAttributes(from globalAttributes: [String: Any]?) -> MutableAttributes {
        guard let globalAttributes else {
            return MutableAttributes()
        }

        return MutableAttributes(from: globalAttributes)
    }
}
