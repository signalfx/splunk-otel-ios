...
if which swiftformat >/dev/null; then
  swiftformat . --lenient --lint --stripunusedargs closure-only --swiftversion 5 --disable indent,consecutiveBlankLines,wrapMultilineStatementBraces, braces,enumNamespaces,blankLinesAtStartOfScope,trailingCommas
else
