...
func addLinkToSpan(span: Span, valStr: String) {
    ...
    span.clearAndSetAttribute(key: NetworkSpanAttributeKeys.linkTraceId, value: traceId)
    span.clearAndSetAttribute(key: NetworkSpanAttributeKeys.linkSpanId, value: spanId)
}
