...
/// Span attribute keys used by network instrumentation that are not covered by
...
/// Attribute values belong in ``NetworkSpanAttributeValues``.
enum NetworkSpanAttributeKeys {
