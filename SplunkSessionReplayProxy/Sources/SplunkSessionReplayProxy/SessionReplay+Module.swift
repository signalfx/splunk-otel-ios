...
public struct SessionReplayRemoteConfiguration: RemoteModuleConfiguration {
    ...
    /// A Boolean value indicating whether the Session Replay module is enabled or disabled through remote configuration.
...
extension SessionReplay: Module {
    ...
    /// The type used for local configuration of the Session Replay module.
    public typealias Configuration = SessionReplayConfiguration
    /// The type used for remote configuration of the Session Replay module.
    public typealias RemoteConfiguration = SessionReplayRemoteConfiguration

    /// The metadata type for events generated by the Session Replay module, represented by ``Metadata``.
    public typealias EventMetadata = Metadata
    /// The data payload type for events, which is the raw `Data` of the session recording.
