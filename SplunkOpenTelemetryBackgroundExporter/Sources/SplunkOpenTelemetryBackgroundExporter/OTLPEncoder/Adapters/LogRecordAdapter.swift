...
enum LogRecordAdapter {
    ...
    private static func groupByScope(_ logRecords: [ReadableLogRecord]) -> [InstrumentationScopeInfo: [ReadableLogRecord]] {
        var result: [InstrumentationScopeInfo: [ReadableLogRecord]] = [:]
