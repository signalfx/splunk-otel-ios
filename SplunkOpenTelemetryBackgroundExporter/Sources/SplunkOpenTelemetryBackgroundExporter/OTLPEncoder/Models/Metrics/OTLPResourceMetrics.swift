...
// MARK: - OTLPResourceMetrics

/// Container for metrics from a single resource.
///
/// ResourceMetrics groups all metrics that share the same resource. Each
/// ResourceMetrics can contain multiple ScopeMetrics from different
...
struct OTLPResourceMetrics: Encodable {

    // MARK: - Properties

    /// The resource associated with these metrics.
    let resource: OTLPResource?

    /// A list of ScopeMetrics from different instrumentation scopes.
    ...
    /// Creates a new ResourceMetrics container.
    ///
    /// - Parameters:
    ///   - resource: The resource associated with these metrics.
    ///   - scopeMetrics: A list of ScopeMetrics from different instrumentation scopes.
