...
extension WebViewInstrumentation: Module {
    ...
    /// The type used for local configuration of the WebView Instrumentation module.
    public typealias Configuration = WebViewInstrumentationConfiguration
    /// The type used for remote configuration of the WebView Instrumentation module.
    public typealias RemoteConfiguration = WebViewInstrumentationRemoteConfiguration

    // Module conformance
    /// The metadata type for events generated by the WebView Instrumentation module.
    public typealias EventMetadata = WebViewInstrumentationMetadata
    /// The data payload type for events generated by the WebView Instrumentation module.
