...
class TestApiCallsViewController: UIViewController {
    ...
    @IBOutlet var cloudkartNetworkButton1: UIButton!
    @IBOutlet var cloudkartNetworkButton2: UIButton!
    @IBOutlet var cloudkartNetworkButton3: UIButton!
    @IBOutlet var cloudkartNetworkButton4: UIButton!
    @IBOutlet var cloudkartNetworkButton5: UIButton!
