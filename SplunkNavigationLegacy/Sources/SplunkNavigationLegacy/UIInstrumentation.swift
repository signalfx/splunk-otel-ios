...
var showVCInstrumentation = true
...
// 📝 Used in AppLifecycle SlowFrameDetector
...
// 📝 ‼️‼️‼️ Called for each span in the onStart method (when Span starts)
