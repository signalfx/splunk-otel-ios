...
// Legacy properties
var screenNameSpansEnabled = true
...
func buildTracer() -> Tracer {
    return OpenTelemetry.instance.tracerProvider.get(instrumentationName: Constants.Globals.INSTRUMENTATION_NAME, instrumentationVersion: "2.0.0")
}

// Assumes main thread
// 📝 Called from public api (track screen)
// 📝 Called from UIInstrumentation
...
//    if oldName != nil && (SplunkRum.configuredOptions?.screenNameSpans ?? true) {
    if oldName != nil && screenNameSpansEnabled {
